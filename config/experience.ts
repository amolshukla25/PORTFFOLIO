...
export const experiences: ExperienceInterface[] = [
  ...
  {
    id: "indian-digital-rey-developer",
    position: "Full-Time Developer",
    company: "Indian Digital Rey",
    location: "India",
    startDate: new Date("2023-01-01"),
    endDate: "Present",
    description: [
      "Develop and ship production software across the full stack — React and Next.js front-ends backed by robust Python services.",
      "Build Python and AI/ML tooling, automation pipelines, and intelligent features that power real user workflows.",
      "Own features end-to-end, from planning and architecture through implementation, testing, and deployment.",
    ],
    achievements: [
      "Delivered full-stack web applications and AI/ML-driven features used in production.",
      "Built Python automation and data pipelines that streamline internal and client workflows.",
      "Collaborate across teams to ship reliable, scalable software while continuously upskilling in AI engineering.",
    ],
    skills: ["Python", "React", "Next.js", "Typescript", "Node.js", "FastAPI"],
  },
  {
    id: "rcpl-trainer",
