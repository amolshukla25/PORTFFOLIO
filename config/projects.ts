  ...
  },
  {
    ...
    descriptionDetails: {
      paragraphs: [
        ...
        "It supports crawling and indexing knowledge from PDFs, URLs, and plain text, and it returns context-aware, source-grounded answers grounded in retrieved content.",
      ],
      bullets: [
        "Built a production-ready AI chatbot platform with a one-line embed widget.",
