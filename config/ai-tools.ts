 ...
 *   2. Prompt Engineering Course (Modules 7–8): prompt anatomy, zero-shot /
 *      few-shot / chain-of-thought, structured outputs, and agentic prompting.
